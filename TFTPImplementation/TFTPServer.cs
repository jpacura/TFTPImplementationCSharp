...
namespace TFTPImplementation
{
    class TFTPServer
    {
        ...
        {
            Console.WriteLine("Simple TFTP Server");
            Console.WriteLine("By Joseph Pacura");
            Console.WriteLine("2018-01-19");
            Console.WriteLine("------------------");
            Console.WriteLine("Starting incoming connection listener on port " + DEFAULT_PORT);
            ...
            catch(SocketException e)
            {
                ...
                Console.WriteLine("ERROR: A socket error has occurred!");
                Console.WriteLine("ERROR: This usually means that the selected port is already in use!");
